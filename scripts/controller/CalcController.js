class CalcController{
    ...
    copyToClipboard(){
        ...
        input.select();
        //document.execCommand("Copy"); Desatualizado
    ...
    getResult(){
        ...
        return eval(this._operation.join(""));    //Comando Join é semente ao toString, porém, ele defini o delimitador na hora de converter para string
